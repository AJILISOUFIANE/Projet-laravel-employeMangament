            ...
            <div class="card my-5">
                ...
                <div class="card-body">
                    <div class="form-group row mb-0">
                        <div class="col-md-12">
                            <a href="{{route('work.vacation',$employe->Matricule)}}"
                                class="btn btn-outline-dark">
                                {{ __('Vacation request') }}
                            </a>
                            <a href="{{route('work.certificate',$employe->Matricule)}}"
                    ...
                    <div class="form-group mb-3">
                        <label for="fullname" class="form-label fw-bold">Matricule</label>
                        <div class="border border-secondary rounded p-2">
                            {{$employe->Matricule}}
                        </div>
                    </div>
